...
import { updateDoctorAvatarAPI } from "../../../services/api.service.doctor";
...
const ViewDoctorDetail = (props) => {
    ...
    const handleUpdateUserAvatar = async () => {
        ...
        const resUpload = await updateUserAvatarAPI(selectedFile,"avt_doctor")
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
                            <div style={{
                                ...
                                <img
                                    src={`${import.meta.env.VITE_BACKEND_URL}/storage/avt_doctor/${dataDetail.avatar}`}
